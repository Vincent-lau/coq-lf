...
Proof.
  ...
  rewrite -> H1. rewrite -> plus_assoc. reflexivity.
Qed.
...
Proof.
  intros n m. induction p as [| p' IHp' ]. intros H.
  - simpl. rewrite -> H. reflexivity.
  - simpl. intros H1. apply IHp'. rewrite -> H1. reflexivity.
Qed.
