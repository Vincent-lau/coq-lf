...
Proof.
  ...
  rewrite -> H2 in H1. injection H1 as H1' H1''.
  transitivity z. apply H1'. rewrite -> H1''. reflexivity.
Qed.
...
Example discriminate_ex3 :
  forall (X : Type) (x y z : X) (l j : list X),
    ...
    x = z.
Proof.
  intros X x y z l L contra. discriminate contra. Qed.
...
Proof.
  ...
  - destruct m as [| m'].
    ...
    + intros H. apply IHn' in H. f_equal. apply H.
  Qed. 
...
Proof.
  ...
  rewrite H1. rewrite H2. simpl. symmetry. apply eqb_refl with (n:=p).
Qed.
(** [] *)
